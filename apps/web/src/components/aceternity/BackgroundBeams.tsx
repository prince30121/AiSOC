...
export function BackgroundBeams({ className }: BackgroundBeamsProps) {
  return (
    ...
    >
      {[
        ['M-380 -189C-380 -189 -312 216 152 343 616 470 684 875 684 875', '#3b82f6'],
        ['M-373 -197C-373 -197 -305 208 159 335 623 462 691 867 691 867', '#1d4ed8'],
        ['M-366 -205C-366 -205 -298 200 166 327 630 454 698 859 698 859', '#8b5cf6'],
        ['M-359 -213C-359 -213 -291 192 173 319 637 446 705 851 705 851', '#3b82f6'],
        ['M-352 -221C-352 -221 -284 184 180 311 644 438 712 843 712 843', '#1d4ed8'],
      ].map(([d, stroke], idx) => (
        <path
          key={idx}
          d={d}
